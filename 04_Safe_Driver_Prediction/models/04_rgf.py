...
from lib.feature import feature_engineering_4
...
def rgf04(x_train, y_train, x_test, folds, max_round, n_splits=5):
    ...
    # Cross Validate
    cv = Cross_Validate(rgf04.__name__, n_splits, x_train.shape[0], x_test.shape[0], clf, -1, -1)
...
if __name__ == '__main__':
    ...
    trn_gini, y_trn, y_tst, fscore = rgf04(x_train, y_train, x_test, folds, MAX_ROUND, n_splits)
