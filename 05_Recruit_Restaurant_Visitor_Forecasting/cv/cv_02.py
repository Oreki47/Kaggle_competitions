''' Explanation
    ...
    very similar to strategy 01 with the only difference that
    we are using 2016 Labor Day holiday as a reference
...
def cross_validate(full_data, clf, seed, ntrain, ntest, features, target, nfolds=5):
    # define
    lst_vld_date = pd.to_datetime('2016-05-31')  # one day before test
